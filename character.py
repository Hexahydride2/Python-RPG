...
class Character:
    def __init__(self, name, level, hp, mp, atk, dfn, spd, inventory, sprite_paths, sprite_width=100, sprite_height=100, scale_factor=3, num_frames_dict=None, animation_speed=5):
        # Character Stats
        self.name = name
        self.level = level
        self.hp = hp
